...
SOCIAL_LINKS = [
    ...
    {
        "key": "instagram",
        "label": "Instagram — Men and Women of Passion and Purpose (@moppandwopp)",
        "username": "@moppandwopp",
        "url": "https://www.instagram.com/moppandwopp",
        "icon": "fab fa-instagram",
    },
    {
        "key": "youtube",
        "label": "YouTube — Men and Women of Passion and Purpose (@menandwomenofpassionandpurpose)",
        "display_name": "@menandwomenofpassionandpurpose",
        "handle": "@menandwomenofpassionandpurpose",
        "url": "https://www.youtube.com/@menandwomenofpassionandpurpose",
        "icon": "fab fa-youtube",
    },
    {
        "key": "tiktok",
